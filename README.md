...
Меня не устраивало, что модуль `random` в Python бывает недостаточно случайным (особенно при нескольких генерациях подряд), поэтому я решил создать свой модуль для генерации псевдослучайных чисел.
